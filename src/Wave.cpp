        ...
        case 1:{
            ...
            switch (waveNumber){
                case 1:{
                    ...
                    rows.insertTail(new Row(Row_1::MIXED, Row_1::TYPE, Row_1::MIN_AMOUNT, Row_1::GRID_FINAL_POS_X, Row_1::GRID_FINAL_POS_Y));
                    if(count != 1){
                        rows.insertTail(new Row(Row_2::MIXED, Row_2::TYPE, Row_2::MIN_AMOUNT, Row_2::GRID_FINAL_POS_X, Row_2::GRID_FINAL_POS_Y));
                    }
                }break;
                case 2:{
