        ...
        case 3:{
            ...
            switch (waveNumber){
                case 1:{
                    ...
                    rows.insertTail(new Row(Row_1::MIXED, Row_1::TYPE, Row_1::MIN_ENEMY_AMOUNT, Row_1::TOTAL_POSITIONS,Row_1::GRID_POS_X, Row_1::GRID_POS_Y, Row_1::DURATION_TICKS, Row_1::TRAJECTORY, Row_1::GRID_FINAL_POS_X, Row_1::GRID_FINAL_POS_Y));
                    if(count != 1){
                        rows.insertTail(new Row(Row_2::MIXED, Row_2::TYPE, Row_2::MIN_ENEMY_AMOUNT, Row_2::TOTAL_POSITIONS,Row_2::GRID_POS_X, Row_2::GRID_POS_Y, Row_2::DURATION_TICKS, Row_2::TRAJECTORY, Row_2::GRID_FINAL_POS_X, Row_2::GRID_FINAL_POS_Y));
                    }
                }break;
                case 2:{
                    using namespace Wave_2;
